...
<html>
<head>
	<title>XSSmh - Challenge 4 - Black Comedy</title>
<link rel="stylesheet" type="text/css" href="../../includes/mcir.css">
</head>
<body>
	<center><h1>XSSmh - Challenge 4 - Black Comedy</h1></center><br>
...
You must evade a naive blacklist filter. All instances of the word "script" will be removed case insensitively from your injection string.<br>
<br>
...
Sanitization - Word "script" is removed
</pre>
...
<form action="../xss.php" method="get" name="challenge_form">
	...
	<input type="hidden" name="sanitization_params" value="script" />
